        ...
        <div class="row">
            ...
            <div class="col-6 mt-4">
                ...
                <h4 class="display-5 text-primary"> Register Route </h4>
                    <form method="POST" class="needs-validation p-2">
                        <div class="mb-3">
            ...
            <?php
              ...
              if(mysqli_num_rows($results) > 0){
                ...
                ?>
                         ...
                         <button style="width : 70%; margin: auto" class="btn btn-block btn-primary" name="next" > <a style="text-decoration : none;" class="text-white" href="../pages/registered_routes.php"> Next </a> </button>
                    </form>
                </div>
            </div>
            <div class="col"></div>
...
if($_SERVER["REQUEST_METHOD"] === "POST"){
   ...
   if(isset($_POST['next'])){
    if(!empty($_POST['bus'])){
        ...
        header('Location: ../pages/registered_routes.php');
    }
   }
}
